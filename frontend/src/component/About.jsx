  ...
  return (
    <section className="py-16">
      <div className="md:flex justify-between pb-16">
        <h1 className="md:text-3xl font-semibold text-eco-light-black max-w-[24rem]">We provide best customer experiences</h1>
      ...
      <div className='flex flex-wrap gap-2 justify-evenly'>
        ...
        <div className="bg-eco-off-white  p-4 rounded-xl">
