      ...
      <div className="grid grid-cols-4 grid-rows-2 gap-2">
       {/* ! image-1  */}
        <Link to={"/products"} className="relative">
          <img
            src="https://images.unsplash.com/photo-1574634534894-89d7576c8259?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=464&q=80"
            alt=""
        ...
        {/* ! image-2  */}
        <Link to={"/products"} className="row-span-2 relative">
          <img
            src="https://images.unsplash.com/photo-1597019558926-3eef445fdf60?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80"
            alt=""
        ...
        <Link to={"/products"} className="relative">
          <img
            src="https://images.pexels.com/photos/13002684/pexels-photo-13002684.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
            className="w-full h-[300px] object-cover object-top hover:brightness-50 transition ease-in"
          />
        ...
        <Link to={"/products"} className="relative">
          <img
            src="https://images.pexels.com/photos/17651315/pexels-photo-17651315/free-photo-of-portrait-of-a-man-standing-in-a-city.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
        ...
        {/* ! image-6  */}
        <Link to={"/products"} className="col-span-2 col-start-3 relative">
          <img
            src="https://images.unsplash.com/photo-1518002171953-a080ee817e1f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80"
            alt=""
