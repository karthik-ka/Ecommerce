      ...
      <div className="flex h-[50px] md:h-[80px] max-w-[380px] md:max-w-[700px] lg:max-w-[900px] xl:max-w-[1280px] m-auto justify-between items-center">
        ...
        <div className="flex">
          <div className="flex relative">
            ...
            <span className="bg-eco-red w-4 h-4 rounded-full absolute -top-1 left-8 text-[10px] font-semibold text-eco-white text-center">
              10
            </span>
          </div>
          <div className="flex relative">
            <ShoppingCartIcon size={43} />
            <span className="bg-eco-red w-4 h-4 rounded-full absolute -top-1 left-4 text-[10px] font-semibold text-eco-white text-center">
              10
            </span>
          </div>
