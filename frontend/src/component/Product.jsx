...
const data = { id: 1, title: "Nike jordan 5xl", subtitle:"Running shoes for men", reviews: "4.5" , image :{
  img1:"../p1.png",img2:"../p2.png",img3:"../p3.png", img4: "../p4.png"
...
const Product = () => {
  ...
  return (
    <section className="lg:flex max-w-[90vw] md:max-w-[700px] lg:max-w-[900px] xl:max-w-[1200px] m-auto py-4 lg:py-16 justify-around">
       {/* -----------------------Image section-------------------------- */}
      ...
      <div className="text-eco-off-black lg:w-[28rem]">
        ...
        <div>
          <h2 className="text-xl font-medium">MRP : ₹{data.price} <span className="text-base line-through">₹{data.prevPrice}</span></h2>
          <span className="text-eco-grey text-sm">incl. of taxes <br /> (Also includes all applicable duties)</span>
        </div>
        <div className="py-8">
          <span className="flex text-md font-semibold justify-between"><h2>Select Size</h2> <h2>Select Guide</h2></span>
        ...
        <div className="md:flex gap-2 lg:flex-col ">
          <button className="text-eco-white bg-eco-off-black text-md my-1 w-full h-14 rounded-full hover:bg-eco-light-black transition ease-in">Add to Cart</button>
          <button className="bg-eco-white border text-md my-1 w-full h-14 rounded-full hover:text-eco-grey transition ease-in">Whishilst <FavoriteBorderIcon /> </button>
        </div>
        <div className=" py-8">
          <h2 className="text-md font-semibold">Product Details</h2>
          <p className="text-sm py-2 leading-relaxed text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi sequi, eligendi ipsam voluptatum tenetur quibusdam reprehenderit facere aliquam quam, quis nesciunt, voluptatibus iste id culpa sint sed accusamus blanditiis pariatur.</p>
        </div>
      </div>
    </section>
